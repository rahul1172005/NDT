...
const Cooperation = () => {
  ...
  const points = [
    { 
      id: '01',
      title: 'STRUCTURES', 
      subtitle: 'STRUCTURAL HEALTH MONITORING & GPR',
    ...
    { 
      id: '02',
      title: 'PIPELINES', 
      subtitle: 'PAUT & CORROSION MAPPING',
    ...
    { 
      id: '03',
      title: 'OFFSHORE', 
      subtitle: 'SUBSEA RADIOGRAPHY & UT',
    ...
    { 
      id: '04',
      title: 'NUCLEAR', 
      subtitle: 'REMOTE VISUAL & THERMAL ANALYSIS',
